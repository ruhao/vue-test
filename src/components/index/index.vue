<template>
	<div>
		<div>
			<div><img class="headerbg" src="http://120.79.22.222:3000/banner1.jpg"/></div>
		</div>
		...
		<div class="wraperwidth">
			<div class="index-product-content">
				<div class="index-product-content-left">
					<img src="http://120.79.22.222:3000/index-products1.jpg" />
				</div>
				<div class="index-product-content-right">
					<div class="index-product-content-right-top">
						<div>
							<img src="http://120.79.22.222:3000/products1-1.jpg" />
						</div>
						<div class="index-product-content-box">
							<img src="http://120.79.22.222:3000/index-products3.jpg" />
						...
						<div>
							<img src="http://120.79.22.222:3000/products1-3.jpg" />
						</div>
					</div>
					<div class="index-product-content-right-bottom">
						<div class="index-product-content-box">
							<img src="http://120.79.22.222:3000/index-products5.jpg" />
						...
						<div>
							<img src="http://120.79.22.222:3000/products1-2.jpg" />
						</div>
						<div class="index-product-content-box">
							<img src="http://120.79.22.222:3000/index-products7.jpg" />
		...
		<div class="index-news-body">
			<div class="wraperwidth">
				<div class="index-news-title">
					<img src="http://120.79.22.222:3000/index-news.jpg" />
				...
				<div class="index-news-content">
					<div class="index-news-content-top">
						<div>
							...
							<img src="http://120.79.22.222:3000/news-con1.png" />
						</div>
						<div>
							<i>
							<span class="index-news-content-span">
							...
							<img src="http://120.79.22.222:3000/news-con4.png" />
						</div>
					</div>
					<div class="index-news-content-top">
						<div>
							...
							<img src="http://120.79.22.222:3000/news-con2.png" />
						</div>
						<div>
							<i>
							<span class="index-news-content-span">
							...
							<img src="http://120.79.22.222:3000/news-con3.png" />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="index-internet-body">
			<img class="imgsize" src="http://120.79.22.222:3000/index-network.jpg" />
		...
		<div class="index-contact">
			<img class="imgsize" src="http://120.79.22.222:3000/index-contact.jpg" />
		...
		<div class="index-cooperation">
			<div class="index-cooperation-top">
				...
				<p class="index-cooperation-footer">老外仓版权所有2014-2019ICP123456789</p>
			</div>
...
export default {
  data () {
    return {
      ...
      contact: [
        {
          icon: 'http://120.79.22.222:3000/index-contact1.png',
          value: '手机：86-15868121781 '
        },
        {
          icon: 'http://120.79.22.222:3000/index-contact2.png',
          value: '座机：86-010-15868121781'
        },
        {
          icon: 'http://120.79.22.222:3000/index-contact3.png',
          value: '邮件：15868121781@qq.com'
        },
        {
          icon: 'http://120.79.22.222:3000/index-contact4.png',
          value: '地址：中国杭州 滨江区 滨盛路1688号'
        }
      ],
      cooperation: [
        'http://120.79.22.222:3000/cooperation-1.png',
        'http://120.79.22.222:3000/cooperation-2.png',
        'http://120.79.22.222:3000/cooperation-3.png',
        'http://120.79.22.222:3000/cooperation-4.png',
        'http://120.79.22.222:3000/cooperation-5.png',
        'http://120.79.22.222:3000/cooperation-6.png'
      ],
      cooperationf: [
        'http://120.79.22.222:3000/cooperation-7.png',
        'http://120.79.22.222:3000/cooperation-8.png'
      ]
    }
  }
}
