<template>
<div>
	<div class='contact-footer' v-if="width<1500&&width>640">
	...
	<div class='midcontact-footer' v-if="width>=1500">
		<div class='midcontact-footer-content'>
  ...
  <div class='mobilecontact-footer' v-if="width<=640">
		<div class='mobilecontact-footer-content'>
  ...
  data () {
    return {
      ...
      contact: [
        {
          icon: contact1,
          value: 'Mobile Phone：17767052082 '
        },
        {
          icon: contact2,
          value: 'Phone：0571-88305872'
        },
        {
          icon: contact3,
        ...
        {
          icon: contact4,
          value: 'Address：No. 1688 BinSheng Rd, BinJiang , Hangzhou, Zhejiang'
        }
      ]
    }
  },
...
.midcontact-footer-content {
  width: 1420px;
  margin: 0 auto;
}

.midindex-footer-method {
  margin-top: 90px;
  list-style: none;
  padding-top: 55px;
  position: relative;
...
.midcontact-footer-li {
  width: 355px;
}

.midcontact-footer-li:nth-of-type(4) {
  text-align: right;
}
...
.mobilecontact-footer {
  background: #f8efe7;
}

.mobilecontact-footer-content {
  width: 100%
}

.mobileindex-footer-method {
  margin-top: 10px;
  list-style: none;
  padding: 20px 0;
  position: relative;
...
.mobileindex-footer-method li {
  float: left;
  min-width: 50%;
}
.mobileindex-footer-method img{
  width: 18px;
  margin-left: 5px;
}
.mobilecontact-span {
